    ...
    return (
        <nav className="fixed top-0 left-0 right-0 bg-white p-4 border-b border-black font-your-font">
            <div className="container mx-auto flex justify-between items-center">
                ...
                <div className={!nav ? "fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-white ease-in-out duration-500 z-10" : "fixed left-[-400%] top-0 w-[60%] h-full border-r border-r-gray-900 bg-white ease-in-out duration-1000"}>
                    <h1 className="md:w-full w-3/4 text-black text-xl md:text-xl font-bold m-4">{t('Operat')}</h1>
                    <ul className="p-4 uppercase font-bold">
                        ...
                        <li className="p-4 border-b border-black">
                            <Link to="/tickets"  onClick={handleNav} className="text-black hover:underline">{t('Buy tickets')}</Link>
                        </li>
                        <li className="p-4 border-b border-black">
